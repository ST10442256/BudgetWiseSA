...
- **Cloud Sync**: Automatically synchronizes all financial data to **Firebase Cloud Firestore** once a connection is restored.
- **Smart Budget Alerts**: Visual indicators that warn users when they hit 80% of their budget or exceed their limits.
- **Advanced Visualization**: Dynamic donut charts and metrics for spending analysis.
- **Gamification**: Reward badges like "7-Day Budget Hero" to encourage consistent financial management.
...
**Developed by:**
- FARANANI NETSHIRANDO (ST10443627)
